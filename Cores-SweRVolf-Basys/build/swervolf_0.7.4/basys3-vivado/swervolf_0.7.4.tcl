...
read_verilog -sv {config/el2_pdef.vh}
read_verilog {../src/cdc_utils_0.1-r1/rtl/verilog/sync2_pgen.v}
read_verilog {../src/cdc_utils_0.1-r1/rtl/verilog/cc561.v}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/include/el2_def.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lib/el2_lib.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lib/beh_lib.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/el2_mem.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/el2_pic_ctrl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/el2_dma_ctrl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/ifu/el2_ifu_aln_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/ifu/el2_ifu_compress_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/ifu/el2_ifu_ifc_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/ifu/el2_ifu_bp_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/ifu/el2_ifu_ic_mem.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/ifu/el2_ifu_mem_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/ifu/el2_ifu_iccm_mem.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/ifu/el2_ifu.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/dec/el2_dec_decode_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/dec/el2_dec_gpr_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/dec/el2_dec_ib_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/dec/el2_dec_tlu_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/dec/el2_dec_trigger.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/dec/el2_dec.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/exu/el2_exu_alu_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/exu/el2_exu_mul_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/exu/el2_exu_div_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/exu/el2_exu.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lsu/el2_lsu.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lsu/el2_lsu_bus_buffer.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lsu/el2_lsu_clkdomain.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lsu/el2_lsu_addrcheck.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lsu/el2_lsu_lsc_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lsu/el2_lsu_stbuf.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lsu/el2_lsu_bus_intf.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lsu/el2_lsu_ecc.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lsu/el2_lsu_dccm_mem.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lsu/el2_lsu_dccm_ctl.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lsu/el2_lsu_trigger.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/dbg/el2_dbg.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/dmi/dmi_wrapper.v}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/dmi/dmi_jtag_to_core_sync.v}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/dmi/rvjtag_tap.v}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/lib/mem_lib.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/el2_swerv.sv}
read_verilog -sv {../src/chipsalliance.org_cores_SweRV_EL2_1.3/design/el2_swerv_wrapper.sv}
source {../src/chipsalliance.org_cores_SweRV_EL2_1.3/tools/vivado.tcl}
...
read_verilog -sv {../src/swervolf_0.7.4/rtl/el2_swerv_wrapper.sv}
